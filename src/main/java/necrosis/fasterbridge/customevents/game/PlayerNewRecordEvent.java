...
public class PlayerNewRecordEvent extends Event {
    //  Make handler list
    ...
    public PlayerNewRecordEvent(Player player,String arena,PlayerClass playerClass,ArenaClass arenaClass,double record){
        this.player     =   player;
