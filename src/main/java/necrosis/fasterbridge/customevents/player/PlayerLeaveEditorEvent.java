...
public class PlayerLeaveEditorEvent extends Event {
    //  Make handler list
    ...
    public PlayerLeaveEditorEvent(Player player,String arenaName,PlayerClass playerClass,ArenaClass arenaClass){
        this.player     =   player;
